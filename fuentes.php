...
<div class="content">
  ...
  <p><strong>Verificación contra fuentes primarias.</strong> Cartografiar solo lo que dicen los medios reproduciría sus errores: si todos coinciden en un dato falso, se publicaría como «consenso». Por eso, durante la síntesis, las <strong>cifras, fechas y decisiones oficiales</strong> centrales se contrastan con fuentes primarias (INE, BOE, Eurostat, boletines oficiales). Lo comprobado aparece en la ficha bajo «Lo que está documentado»; cuando un dato que los medios dan por bueno no se sostiene con una fuente independiente, se señala explícitamente como dato en disputa en lugar de silenciarlo.</p>
